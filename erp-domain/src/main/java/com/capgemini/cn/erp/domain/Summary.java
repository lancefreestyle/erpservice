...
public class Summary implements Serializable {
	...
	//bi-directional many-to-one association to SummaryItem
	...
	public SummaryItem addSummaryItem(SummaryItem summaryItem) {
		getSummaryItems().add(summaryItem);
		summaryItem.setSummary(this);

		return summaryItem;
	}

	public SummaryItem removeSummaryItem(SummaryItem summaryItem) {
		getSummaryItems().remove(summaryItem);
		summaryItem.setSummary(null);
